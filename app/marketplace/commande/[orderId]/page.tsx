...
import { getOrder, ORDER_STATUS_LABEL } from "@/lib/marketplace";
...
export default async function CommandeConfirmee({
  ...
  return (
    <main className="flex min-h-dvh flex-1 flex-col items-center px-7 pt-[64px] text-center sm:min-h-0">
      ...
      <h1 className="mb-1.5 font-display text-[18px] font-semibold">Réservation confirmée</h1>
      ...
      <Card className="mb-3 w-full p-4 text-left">
        <div className="mb-2 flex items-center justify-between">
          ...
          <StatusPill tone="info">{ORDER_STATUS_LABEL[order.status]}</StatusPill>
        </div>
      ...
      <div className="mb-6 w-full rounded-card bg-gold/22 p-3.5">
